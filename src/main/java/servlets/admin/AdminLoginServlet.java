...
public class AdminLoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            // Authenticate admin using EditUsersTable
            EditUsersTable editUsersTable = new EditUsersTable();
            User user = editUsersTable.databaseToUsers(username, password);

            // Check if authentication is successful and user is admin
            if (user != null && "admin".equals(username) && "admiN12@*".equals(password)) {
                ...
                out.print("{\"success\": true, \"sessionToken\": \"" + sessionToken + "\", \"message\": \"Login successful\"}");
                out.flush();
            } else {
